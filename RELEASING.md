...
```bash
gh release download v0.3.0 --repo rootlyhq/rootly-datadog-notification-migrator
sha256sum --check SHA256SUMS
gh attestation verify rootly-datadog-notification-migrator-0.3.0.tgz \
...
gh attestation verify \
  oci://ghcr.io/rootlyhq/rootly-datadog-notification-migrator:0.3.0 \
  --repo rootlyhq/rootly-datadog-notification-migrator
```
